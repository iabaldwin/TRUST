...
fixed_dict = {
            ...
            'flame_model_path': './data/female_model.pkl',
...
if __name__ == '__main__':
    ...
    assert os.path.isfile(config.pretrained_modelpath_scene)
    assert os.path.isfile(config.pretrained_modelpath_facel)
    assert os.path.isfile(config.pretrained_modelpath_albedo)
    ...
    trust.infer('/home/ian/code/TRUST/206150648_1060635994468015_4078959400479811793_n.png')
    # trust.infer('/home/ian/code/TRUST/163123371_521597738822746_5491387094153162184_n.png')
